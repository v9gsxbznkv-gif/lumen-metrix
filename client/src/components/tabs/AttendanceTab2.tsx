  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-[10px] font-medium transition-colors ${
        cancelled
          ? "bg-red-200 text-red-800 hover:bg-red-300 dark:bg-red-900/40 dark:text-red-300"
          : "bg-green-200 text-green-800 hover:bg-green-300 dark:bg-green-900/40 dark:text-green-300"
